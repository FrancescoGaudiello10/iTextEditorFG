...
import com.sun.webkit.ColorChooser;
	...
	public class TextEditor extends Frame {
		...
		TextEditor(){
			...
			file.add(n);
			o.addActionListener(new New());
			file.add(o);
			s.addActionListener(new New());
			file.add(s);
			e.addActionListener(new New());
			file.add(e);
		...
		class B implements ActionListener{
			public void actionPerformed(ActionEvent e) {
				System.out.println("Il colore è: "+jcc.getColor().toString());
